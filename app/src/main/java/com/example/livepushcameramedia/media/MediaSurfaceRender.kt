...
class MediaSurfaceRender(var context: Context) : EGLSurfaceRender,
    ...
    private val fboRender = MediaFboRender(context)
...
//            180 -> Matrix.rotateM(matrix,0,90f,0f,0f,1f)
    ...
    override fun onDrawFrame() {
        ...
        //绘制fbo中的texture
        //这里绘制的画面只是能看到，不会传到编码器，因此编码器的render需要一份相同的代码
